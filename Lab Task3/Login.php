...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
  ...
  <br><br>
  <span style = "display:inline-block; width:430px;text-align:right;"><input type="submit" name="submit" value="Submit"> </span> <a href="https://www.w3schools.com">Forgot password?</a>
